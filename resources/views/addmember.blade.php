        ...
        <div class="card-text">  
            <form method="POST" action="addmember" enctype="multipart/form-data">  
                ...
                <div class="form-group">  
                    ...
                    <input type="text" class="form-control form-control-sm" name="name" id="exampleInputname" aria-describedby="nameHelp">  
                    @error('name')
                ...
                <div class="form-group">  
                    ...
                    <input type="text" class="form-control form-control-sm" name="Phone_number" id="exampleInputnumber"> 
                    @error('Phone_number')
                    <div class="alert alert-danger" style="bottom:10px;" role="alert"> {{$message}} </div>
                    @enderror     
                </div> 
               ...
               <!-- E-mail Field -->
                <div class="form-group">  
                    ...
                    <input type="text" class="form-control form-control-sm" name="email" id="exampleInputemail">  
                    @error('email')
                    <div class="alert alert-danger" style="bottom:10px;" role="alert"> {{$message}} </div>
                    @enderror   
                </div>  
                ...
                <div class="form-group">  
                    ...
                    <input type="file" class="form-control form-control-sm" name="Attachment" id="exampleInputfile"> 
                    @error('Attachment')
                    <div class="alert alert-danger" style="bottom:10px;" role="alert"> {{$message}} </div>
                    @enderror 
                </div> 
